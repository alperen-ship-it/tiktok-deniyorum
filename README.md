...
Üç oyun bir arada döner: bilye yarışı · battle royale · at yarışı bahsi.
...
### 💀 Son Ayakta Kalan
Battle royale. Yazan herkes arenaya bir jeton olarak düşer. Her tur bir **felaket**
gelir — ☄️ meteor, 🌊 dalga, 🕳️ çukur, ⚡ yıldırım — vurmadan önce nereye
vuracağı kırmızıyla gösterilir. O anda **sohbete yazan jetonunu kaçırır.** Dev
"N KALDI" sayacı geriye sayar, son ikide SON DÜELLO. Tek kişi kalana kadar.
...
| `?oyunlar=bilye,at` | Hangi oyunlar, hangi sırayla |
